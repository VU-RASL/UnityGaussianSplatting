...
namespace GSAvatar.Runtime
{
    ...
    [ExecuteInEditMode]
    public class GSAvatarRenderer : MonoBehaviour
    {
        ...
        public void CreateResourcesForAsset()
        {
            ...
            // m_GpuPosData = asset.m_GpuPosData;
        ...
        internal void SetAssetDataOnMaterial(MaterialPropertyBlock mat)
        {
            if (updatedPositionsBuffer != null)
            {
                ...
                Debug.Log("GSAvatarRenderer testetttttttttttttttttttttttttttt.");
            }
            else
            {
        ...
        public void EditCopySplatsInto(GSAvatarRenderer dst, int copySrcStartIndex, int copyDstStartIndex, int copyCount)
        {
            EditCopySplats(
                dst.transform,
