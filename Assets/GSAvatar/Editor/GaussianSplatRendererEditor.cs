...
using UnityEngine;
using GSAvatarRenderer = GSAvatar.Runtime.GSAvatarRenderer;

namespace GSAvatar.Editor
{
    [CustomEditor(typeof(GSAvatarRenderer))]
    [CanEditMultipleObjects]
    public class GSAvatarRendererEditor : UnityEditor.Editor
    {
        ...
        static HashSet<GSAvatarRendererEditor> s_AllEditors = new();
        ...
        {
            var gs = target as GSAvatarRenderer;
            if (!gs)
                return;
            ...
            if (m_PropRenderMode.intValue is (int)GSAvatarRenderer.RenderMode.DebugPoints or (int)GSAvatarRenderer.RenderMode.DebugPointIndices)
        ...
        void EditCameras(GSAvatarRenderer gs)
        {
            var asset = gs.asset;
        ...
        void MultiEditGUI()
        {
            ...
            var targetGs = (GSAvatarRenderer) target;
        ...
        void CountTargetSplats(out int totalSplats, out int totalObjects)
        {
            ...
            {
                var gs = obj as GSAvatarRenderer;
        ...
        void EditGUI(GSAvatarRenderer gs)
        {
            ++s_EditStatsUpdateCounter;
        ...
        static unsafe void ExportPlyFile(GSAvatarRenderer gs, bool bakeTransform)
        {
