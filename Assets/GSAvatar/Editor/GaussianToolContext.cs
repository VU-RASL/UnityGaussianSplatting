...
{
    [EditorToolContext("GaussianSplats", typeof(GSAvatarRenderer)), Icon(k_IconPath)]
    class GaussianToolContext : EditorToolContext
    {
        const string k_IconPath = "Assets/GSAvatar/Editor/Icons/GaussianContext.png";
        ...
        static void HandleKeyboardCommands(Event evt, GSAvatarRenderer gs)
        {
        ...
        public override void OnToolGUI(EditorWindow window)
        {
            ...
            GSAvatarRendererEditor.BumpGUICounter();
            ...
            switch (evtType)
            {
                ...
                case EventType.Repaint:
                    ...
                    {
                        var selBounds = GSAvatarRendererEditor.TransformBounds(gs.transform, gs.editSelectedBounds);
